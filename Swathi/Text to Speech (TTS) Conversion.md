...
## Description
Here, ESP32 is used to build a TTS (Text to Speech) engine which can convert any number into speech. 
The number will be entered from a Webpage and speech will be generated from ESP32 attached speaker.
## Prerequisites
* Arduino IDE
...
You can ponder on the reverse of this problem statement and how speech can be converted to text.
You can follow Tensorflowlite's official documentation to find a project built around the same idea for inspiration
## References
* [ESP32 based Webserver for Text to Speech (TTS) Conversion](https://iotdesignpro.com/projects/esp32-based-text-to-speech-converter-webserver)
